...
- **서체**: Pretendard Variable (`400`, `500`, `600`, `700`, `800`)
- **브랜드 컬러 토큰**:
  - `Primary Navy`: `#0e3a6c` (켑코이에스 시그니처 딥 네이비)
  - `Primary Blue`: `#1976d2` (핵심 액션 및 PMS 포인트 블루)
  - `Energy Orange`: `#ff7a00` (에너지 효율 심볼 오렌지)
